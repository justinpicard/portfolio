<template>
  <div class="home-hero d-flex justify-center" ref="root">
    <div class="limits"></div>
    <div class="half"></div>
	<h1 class="d-flex flex-column justify-center items-center mb-16">
		<span class="name text-2xl mb-0">Justin Picard</span>
		<span class="role text-lg font-body font-regular">Digital product designer</span>
	</h1>
